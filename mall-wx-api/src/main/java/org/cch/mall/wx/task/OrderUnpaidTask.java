...
import org.cch.mall.db.service.MallOrderGoodsService;
import org.cch.mall.db.service.MallOrderService;
import org.cch.mall.db.util.OrderUtil;
import org.cch.mall.wx.service.WxOrderService;
...
public class OrderUnpaidTask extends Task {
    ...
    public void run() {
        ...
        MallOrderGoodsService orderGoodsService = BeanUtil.getBean(MallOrderGoodsService.class);
        MallGoodsProductService productService = BeanUtil.getBean(MallGoodsProductService.class);
        WxOrderService wxOrderService = BeanUtil.getBean(WxOrderService.class);

        MallOrder order = orderService.findById(this.orderId);
        if(order == null){
            return;
        }
