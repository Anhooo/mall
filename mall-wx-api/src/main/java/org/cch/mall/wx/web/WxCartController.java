...
import static org.cch.mall.wx.util.WxResponseCode.GOODS_NO_STOCK;
import static org.cch.mall.wx.util.WxResponseCode.GOODS_UNSHELVE;
...
public class WxCartController {
    ...
    public Object index(@LoginUser Integer userId) {
        ...
        List<MallCart> list = cartService.queryByUid(userId);
    ...
    public Object checkout(@LoginUser Integer userId, Integer cartId, Integer addressId, Integer couponId, Integer userCouponId, Integer grouponRulesId) {
        ...
        for(MallCouponUser couponUser : couponUserList){
            MallCoupon coupon = couponVerifyService.checkCoupon(userId, couponUser.getCouponId(), tmpUserCouponId, checkedGoodsPrice);
            if(coupon == null){
                continue;
            }
