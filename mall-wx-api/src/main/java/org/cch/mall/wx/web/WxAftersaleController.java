...
public class WxAftersaleController {
    ...
    public Object list(@LoginUser Integer userId,
        ...
        List<MallAftersale> aftersaleList = aftersaleService.queryList(userId, status, page, limit, sort, order);

        List<Map<String, Object>> aftersaleVoList = new ArrayList<>(aftersaleList.size());
        for (MallAftersale aftersale : aftersaleList) {
            List<MallOrderGoods> orderGoodsList = orderGoodsService.queryByOid(aftersale.getOrderId());
    ...
    public Object detail(@LoginUser Integer userId, @NotNull Integer orderId) {
        ...
        MallAftersale aftersale = aftersaleService.findByOrderId(userId, orderId);
     ...
     */
    @PostMapping("submit")
    public Object submit(@LoginUser Integer userId, @RequestBody MallAftersale aftersale) {
        if (userId == null) {
            return ResponseUtil.unlogin();
        }
     ...
     */
    @PostMapping("cancel")
    public Object cancel(@LoginUser Integer userId, @RequestBody MallAftersale aftersale) {
        if (userId == null) {
            return ResponseUtil.unlogin();
        }
        ...
        MallAftersale aftersaleOne = aftersaleService.findById(userId, id);
    ...
    private Object validate(MallAftersale aftersale) {
