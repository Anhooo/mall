...
import org.cch.mall.core.util.SystemInfoPrinter;
import org.cch.mall.db.service.MallSystemConfigService;
...
class SystemInistService {
    ...
    static {
        ...
        DEFAULT_CONFIGS.put(SystemConfig.MALL_WX_INDEX_BRAND, "4");
        DEFAULT_CONFIGS.put(SystemConfig.MALL_WX_INDEX_TOPIC, "4");
        DEFAULT_CONFIGS.put(SystemConfig.MALL_WX_INDEX_CATLOG_LIST, "4");
        DEFAULT_CONFIGS.put(SystemConfig.MALL_WX_INDEX_CATLOG_GOODS, "4");
        DEFAULT_CONFIGS.put(SystemConfig.MALL_WX_SHARE, "false");
        // 运费相关配置默认值
        ...
        // 商城相关配置默认值
        DEFAULT_CONFIGS.put(SystemConfig.MALL_MALL_NAME, "mall");
        DEFAULT_CONFIGS.put(SystemConfig.MALL_MALL_ADDRESS, "上海");
        DEFAULT_CONFIGS.put(SystemConfig.MALL_MALL_Latitude, "31.201900");
        DEFAULT_CONFIGS.put(SystemConfig.MALL_MALL_LONGITUDE, "121.587839");
        DEFAULT_CONFIGS.put(SystemConfig.MALL_MALL_PHONE, "021-xxxx-xxxx");
        DEFAULT_CONFIGS.put(SystemConfig.MALL_MALL_QQ, "88888888");
    }
    ...
    private void initConfigs() {
        // 1. 读取数据库全部配置信息
        Map<String, String> configs = mallSystemConfigService.queryAll();
        ...
        for (Map.Entry<String, String> entry : DEFAULT_CONFIGS.entrySet()) {
            ...
            mallSystemConfigService.addConfig(entry.getKey(), entry.getValue());
        }
    ...
    private Map<String, String> getSystemInfo() {
        ...
        infos.put("调试级别", environment.getProperty("logging.level.org.cch.mall.wx"));
        ...
        infos.put("微信APP KEY", environment.getProperty("mall.wx.app-id"));
        infos.put("微信APP-SECRET", environment.getProperty("mall.wx.app-secret"));
        infos.put("微信支付MCH-ID", environment.getProperty("mall.wx.mch-id"));
        infos.put("微信支付MCH-KEY", environment.getProperty("mall.wx.mch-key"));
        infos.put("微信支付通知地址", environment.getProperty("mall.wx.notify-url"));
