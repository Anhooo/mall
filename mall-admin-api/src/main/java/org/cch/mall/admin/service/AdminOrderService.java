package org.cch.mall.admin.service;
...
import static org.cch.mall.admin.util.AdminResponseCode.*;
...
public class AdminOrderService {
    ...
    public Object list(Integer userId, String orderSn, LocalDateTime start, LocalDateTime end, List<Short> orderStatusArray,
        ...
        List<MallOrder> orderList = orderService.querySelective(userId, orderSn, start, end, orderStatusArray, page, limit,
                sort, order);
...
//        }
    ...
    public Object reply(String body) {
        ...
        // 目前只支持回复一次
        MallComment comment = commentService.findById(commentId);
        if(comment == null){
            return ResponseUtil.badArgument();
        }
