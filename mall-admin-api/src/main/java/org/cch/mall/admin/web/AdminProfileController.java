...
import org.cch.mall.core.util.bcrypt.BCryptPasswordEncoder;
...
import org.cch.mall.db.service.MallAdminService;
import org.cch.mall.db.service.MallNoticeAdminService;
import org.cch.mall.db.service.MallNoticeService;
...
import static org.cch.mall.admin.util.AdminResponseCode.ADMIN_INVALID_ACCOUNT;
...
public class AdminProfileController {
    ...
    @Autowired
    private MallNoticeService noticeService;
    @Autowired
    private MallNoticeAdminService noticeAdminService;
    ...
    public Object lsNotice(String title, String type,
        ...
        List<MallNoticeAdmin> noticeList = noticeAdminService.querySelective(title, type, getAdminId(), page, limit, sort, order);
    ...
    public Object catNotice(@RequestBody String body) {
        ...
        MallNoticeAdmin noticeAdmin = noticeAdminService.find(noticeId, getAdminId());
        if(noticeAdmin == null){
        ...
        MallNotice notice = noticeService.findById(noticeId);
        ...
        if(adminId.equals(0)){
            ...
            MallAdmin admin = adminService.findById(notice.getAdminId());
